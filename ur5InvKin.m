...
%   Input args:
%           gd - the 4x4 matrix - desired transformation from base_link to
%           tool0
%   Output args:
%           theta - 6x8 matrix, each colum represents one possible solution 
%           of joint angles

% Updated by: Jakub Piwowarczyk, 12/05/2023
    ...
    for i=1:length(cols)
        ...
        % T14 = T10 * gd * T65 * T54;
        T01 = DH(a1, alpha1, d1, theta(1,c));
        T56 = DH(a6, alpha6, d6, theta(6,c));
        T45 = DH(a5, alpha5, d5, theta(5,c));
        T14 = T01 \ gd / (T45 * T56);
    ...
    for i=1:length(cols)
        ...
        % T34 = T32 * T21 * T14;
        T23 = DH(a3, alpha3, d3, theta(3,c));
        T12 = DH(a2, alpha2, d2, theta(2,c));
        T34 = (T12 * T23) \ T14;
